                                            ...
                                            <div class="c-tab-pane">
                                                <form class="c-form-register c-margin-t-20" method="post" action="{{ route('register') }}" enctype="multipart/form-data" >
                                                    ...
                                                    <div class="col-md-6 col-md-offset-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">{{ __('Store Email') }} <span class="red">*</span></label>
                                                            <input type="text" name="store_email" value="{{ old('store_email') }}" class="form-control c-square c-theme" placeholder="{{ __('Store Email') }}">
                                                        </div>
