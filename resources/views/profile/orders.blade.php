                ...
                <div class="c-content-product-2 c-bg-white">
                    <div class="col-md-2">
                        <div class="c-content-overlay">
                            <a href="{{ route('profile.orders.show',1) }}">
                    ...
                    <div class="col-md-10">
                        <div class="c-info-list">
                            <h3 class="c-title c-font-bold c-font-22 c-font-dark">
                                <p class="c-font-14 c-font-thin">Order #: 1104</p>
                                <a class="c-theme-link" href="{{ route('profile.orders.show',1) }}">26 August 2015</a>
                            </h3>
                            <p class="c-order-date c-font-14 c-font-thin c-theme-font">Status</p>
                            <p class="c-price c-font-26 c-font-thin">$548</p>
                            <p class="c-payment-type c-font-14 c-font-bold">via Credit Card (Mastercard)</p>
                        </div>
                    </div>
                </div>
            </div>
