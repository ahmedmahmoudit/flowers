                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" name="name_en" class="form-control" id="inputNameEn" placeholder="Enter English Name" value="{{$category->name_en or old('name_en')}}">
                                    <p class="help-block"></p>
                                </div>
                                <div class="col-xs-6">
                                    <label for="inputNameAr">Name Arabic</label>
                                    <input type="text" name="name_ar" class="form-control" id="inputNameAr" placeholder="Enter Arabic Name" value="{{$category->name_ar or old('name_ar')}}">
                                    <p class="help-block"></p>
                                </div>
                            </div>
                            <div class="form-group">
