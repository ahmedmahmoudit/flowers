                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    {{--<div class="input-group-addon">--}}
                                        {{--<i class="fa fa-calendar"></i>--}}
                                    {{--</div>--}}
                                    <input type="text" class="form-control pull-right for-sale" name="delivery_days" value="{{old('delivery_days')}}" id="delivery_days" placeholder="{{ __('Minimum Delivery Days') }}">
                                </div>
